...
//        }
    ...
    private String buildString(boolean appendUser, boolean appendParameter, String... parameters) {
        return buildString(appendUser, appendParameter, true, false, parameters);
    }
    ...
    public String getServiceName() {
        return getParameter(Constants.SERVICE_NAME_KEY, path);
    }

    public URL setServiceName(String service) {
        return addParameter(Constants.SERVICE_NAME_KEY, service);
    }
