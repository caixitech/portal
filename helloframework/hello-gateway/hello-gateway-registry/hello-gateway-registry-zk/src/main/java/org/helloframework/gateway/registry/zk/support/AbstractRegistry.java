...
import org.helloframework.gateway.common.utils.ConcurrentHashSet;
import org.helloframework.gateway.common.utils.URL;
import org.helloframework.gateway.common.utils.UrlUtils;
...
//    private final Properties properties = new Properties();
    ...
    // 文件缓存定时写入
//    private final ExecutorService registryCacheExecutor = Executors.newFixedThreadPool(1, new NamedThreadFactory("HelloSaveRegistryCache", true));
...
//        String filename = url.getParameter(Constants.FILE_KEY, System.getProperty("user.home") + "/.hello/hello-registry-" + url.getHost() + ".cache");
//        File file = null;
...
//    }
    ...
    protected void notify(URL url, NotifyListener listener, List<URL> urls) {
        ...
        if ((urls == null || urls.size() == 0)
                && !Constants.ANY_VALUE.equals(url.getPath())) {
